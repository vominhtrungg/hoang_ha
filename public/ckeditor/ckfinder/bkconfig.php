...
$config['licenseKey']  = 'GJJJ4V2WPEUN8Q1KJSDN4SUMTDVNM';
...
$config['privateDir'] = array(
    'backend' => 'dienmaycholondemo.vn/public_html',
    'tags'   => '.ckfinder/tags',
    'logs'   => '.ckfinder/logs',
...
/*if(false){
    $config['backends'][] = array(
        'name'         => 'dienmaycholondemo.vn/public_html',
        'adapter'      => 'ftp',
        'host'         => '113.161.85.142',
        'port'         => 2121,
        'username'     => 'tin',
        'password'     => 'tin@2020#',
        'baseUrl'      => "http://113.161.85.142/userupload/images/",
        'root'          => "dienmaycholondemo.vn/public_html/userupload/images/",
    );
}else{
...
*/
 $config['backends'][] = array(
        ...
        'host'         => '172.16.200.150',
        'port'         => 21,
        'username'     => 'webdmclstatitc.u',
        'password'     => 'Web@staticDMCL',
        'baseUrl'      => "https://cdn01.dienmaycholon.vn/filewebdmclnew/",
        'root'          => "/public/",
    );
...
$config['resourceTypes'][] = array(
   ...
   // 'directory'         => 'dienmaycholondemo.vn/public_html/userupload/files',
     'directory'         => '/',
    'maxSize'           => 0,
...
$config['resourceTypes'][] = array(
    'name'              => 'Images',
    'directory'         => 'dienmaycholondemo.vn/public_html/userupload/images/',
    'maxSize'           => 0,
